...
func TestRepoDigest(t *testing.T) {
	...
	digests := []struct {
		...
		Repo	string
	}{{Digest: digest.Digest("sha256:4355a46b19d348dc2f57c046f8ef63d4538ebb936000f3c9ee954a27460dd865"), Repo: "foo"}, {Digest: digest.Digest("sha256:53c234e5e8472b6ac51c1ae1cab3fe06fad053beb8ebfd8977b010655bfdd3c3"), Repo: "foo"}, {Digest: digest.Digest("sha256:1121cfccd5913f0a63fec40a6ffd44ea64f9dc135c66634ba001d10bcf4302a2"), Repo: "bar"}, {Digest: digest.Digest("sha256:1121cfccd5913f0a63fec40a6ffd44ea64f9dc135c66634ba001d10bcf4302a2"), Repo: "foo"}}
	now := time.Now()
	...
	r := &repositoryDigest{Cache: cache}
...
func TestRepoDigestRemove(t *testing.T) {
	...
	digests := []struct {
		Digest	digest.Digest
		Repo	string
	}{{Digest: dgst, Repo: "bar"}, {Digest: dgst, Repo: "foo"}}
	now := time.Now()
	clock := clock.NewFakeClock(now)
	cache, err := NewBlobDigest(2, 3, ttl1m, metrics.NewNoopMetrics())
	if err != nil {
