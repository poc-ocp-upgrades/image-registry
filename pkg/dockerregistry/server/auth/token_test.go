...
func TestSimpleScope(t *testing.T) {
	...
	checkResolveScopeSpecifiers(t, []string{"repository:namespace/name:pull,push,pull"}, []auth.Access{{Resource: auth.Resource{Type: "repository", Class: "", Name: "namespace/name"}, Action: "pull"}, {Resource: auth.Resource{Type: "repository", Class: "", Name: "namespace/name"}, Action: "push"}})
	checkResolveScopeSpecifiers(t, []string{"repository:namespace/name:"}, []auth.Access{{Resource: auth.Resource{Type: "repository", Class: "", Name: "namespace/name"}, Action: ""}})
	checkResolveScopeSpecifiers(t, []string{"repository::"}, []auth.Access{{Resource: auth.Resource{Type: "repository", Class: "", Name: ""}, Action: ""}})
